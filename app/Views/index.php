...
<head>
    ...
    <meta name="description" content="Website resmi Desa Cigugur Bersemi - Informasi, berita, dan layanan desa" />
    <meta name="keywords" content="Desa Cigugur, Cigugur Bersemi, Kuningan, Jawa Barat" />
...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <p class="lead">
                        Situs resmi sistem informasi desa yang menyediakan berita, agenda, dan informasi terkini seputar
                        perkembangan desa kami.
                    </p>
                    <div class="mt-4">
                        <a href="<?= base_url('VisiMisi') ?>" class="btn btn-primary btn-lg me-3">Visi & Misi</a>
                        <a href="<?= base_url('Kontak') ?>" class="btn btn-outline-primary btn-lg">Hubungi Kami</a>
                    </div>
                </div>
                <div class="col-lg-6 text-center">
                    <img src="<?= base_url('assets/img1.jpg') ?>" alt="Foto Desa Cigugur Bersemi"
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-6 mb-4">
                    <div class="p-4 bg-light shadow-sm rounded h-100">
                        ...
                        <p>
                            "Mewujudkan Desa Cigugur Bersemi sebagai desa yang maju, mandiri, berdaya saing, dan
                            berlandaskan nilai-nilai kebersamaan, gotong royong, serta kearifan lokal."
                        </p>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="<?= base_url('assets/desa.jpg') ?>" alt="Gambar Sejarah Desa"
                        class="img-fluid rounded shadow-sm" />
                </div>
                <div class="col-md-6">
                    <div class="p-3">
                        <p>
                            Desa Cigugur Bersemi memiliki sejarah panjang yang mencerminkan semangat perjuangan dan
                            kebersamaan masyarakatnya. Didirikan pada awal abad ke-20, desa ini berawal dari sebuah
                            komunitas kecil petani dan pengrajin yang hidup berdampingan dengan alam.
                        </p>
                        <p>
                            Seiring waktu, Cigugur Bersemi tumbuh menjadi desa yang mandiri dan produktif. Banyak tokoh
                            lokal yang turut berjasa dalam membangun infrastruktur, memperjuangkan pendidikan, dan
                            menjaga nilai-nilai adat serta budaya setempat.
                        </p>
                        <p>
                            Hingga kini, sejarah desa terus diwariskan dari generasi ke generasi sebagai identitas dan
                            kebanggaan bersama warga Desa Cigugur Bersemi.
                        </p>
                        <a href="<?= base_url('Sejarah') ?>" class="btn btn-primary mt-3">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-4 text-center mb-4 mb-md-0">
                    <img src="<?= base_url('assets/kades-kawe.jpg') ?>" alt="Foto Kepala Desa"
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        Bapak/Ibu Nama Kepala Desa adalah pemimpin yang berdedikasi pada pengembangan dan kemajuan Desa
                        Cigugur Bersemi. Memimpin berbagai program pembangunan desa yang berfokus pada peningkatan
                        kesejahteraan masyarakat dan pelestarian budaya lokal.
                    </p>
                    <ul class="list-unstyled">
                        <li><strong>Masa Jabatan:</strong> 2021 - 2027</li>
                        <li><strong>Email:</strong> <a
                                href="mailto:kepala@cigugurbersemi.id">kepala@cigugurbersemi.id</a></li>
                        <li><strong>Telepon:</strong> <a href="tel:081234567890">0812-3456-7890</a></li>
                    </ul>
                    <a href="<?= base_url('Kades') ?>" class="btn btn-outline-primary">Lihat Profile Lengkap</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-4 mb-md-0">
                    <div class="bg-white p-4 rounded shadow-sm">
                        ...
                        <p class="mb-2"><strong>Telepon:</strong> <a href="tel:0232888456">(0232) 888-456</a></p>
                        <p class="mb-2"><strong>Email:</strong> <a
                                href="mailto:info@cigugurbersemi.id">info@cigugurbersemi.id</a></p>
                        <p class="mb-0"><strong>Jam Operasional:</strong> Senin - Jumat, 08:00 - 16:00 WIB</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="ratio ratio-4x3 shadow-sm rounded overflow-hidden">
                        <iframe
                            ...
                            referrerpolicy="no-referrer-when-downgrade" title="Lokasi Kantor Desa Cigugur Bersemi">
                        </iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <ul class="list-unstyled pt-2">
                        ...
                        <li class="py-1"><a href="<?= base_url('RiwayatKades') ?>"
                                class="text-light text-decoration-none">Data Riwayat Kepala Desa</a></li>
                    </ul>
                </div>
                <div class="col">
                    <h4>Lanjutan</h4>
    ...
    <script src="<?= base_url('/others/js/index.js') ?>"> </script>
</body>
